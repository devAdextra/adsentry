            ...
            <div class="row pt-5">
                <div class="col-lg-12">
                    <div class="text-center error-pages">
                        <h1 class="error-title text-primary mb-3">505</h1>
                        <h2 class="error-sub-title text-dark">505 HTTP Version Not Supported</h2>

                        <p class="error-message text-secondary text-uppercase">SORRY, ci sono stati problemi con il server!</p>
